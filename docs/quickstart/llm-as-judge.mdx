...
- **Path A — Public Playground (no signup):** the fastest way to see it work.
- **Path B — Dashboard (UI):** build and save a judge from your dashboard.
- **Path C — Dashboard (API):** create the same judge programmatically.
...
Your judge is saved as an **Experiment**, and the **Integration** tab gives you a copy-paste snippet with your real model name and key prefilled. See [Integration](https://app.notion.com/p/Quick-Start-LLM-as-Judge-36f626e3f69a8030bbe1e58cdd37730a?pvs=21) below.
...
Fill in the **Metric** and **Criteria** ([defined above](https://app.notion.com/p/Quick-Start-LLM-as-Judge-36f626e3f69a8030bbe1e58cdd37730a?pvs=21)). We'll use the same `anger` judge as in Path A.
...
Ready to ship it? Head to [Integration](https://claude.ai/chat/85b716b8-ac1c-4f5f-9009-3f5cad24fcba#integration).
