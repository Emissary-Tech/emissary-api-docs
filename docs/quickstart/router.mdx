...
- [**Path A — Public Playground (no signup)](https://app.notion.com/p/Quick-Start-Router-36e626e3f69a80b29090f237b1a23587?pvs=21):** the fastest way to see it work.
- **Path B — Dashboard (UI):** build and save a router from your dashboard.
- **Path C — Dashboard (API):** create the same router programmatically.
...
![custom-router](/img/quickstart/router/custom-router.png)
...
Your router is saved as an **Experiment**, and the **Integration** tab gives you a copy-paste snippet with your real model name and key prefilled. See [Integration](https://app.notion.com/p/Quick-Start-Router-36e626e3f69a80b29090f237b1a23587?pvs=21) below.
...
Define each route's **Name** and **Description** ([defined above](https://app.notion.com/p/Quick-Start-Router-36e626e3f69a80b29090f237b1a23587?pvs=21)). We'll use the same three routes as in Path A. Add more by clicking **Add route** at the top right.

![route-config](/img/quickstart/router/route-config.png)
...
Ready to ship it? Head to [Integration](https://app.notion.com/p/Quick-Start-Router-36e626e3f69a80b29090f237b1a23587?pvs=21).
