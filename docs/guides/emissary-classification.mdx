...
"This is a sample text for binary classification",{"is_cat": 1}
"This is another sample text for binary classification",{"is_cat": 0}
...
- **Rebalance Dataset:** You can also rebalance your train dataset
- **Hyper Parameters:** Default hyper parameters’ value is all set but you can adjust the value if you want
